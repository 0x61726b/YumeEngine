...
namespace dune
{
	...
	void light_propagation_volume::inject(ID3D11DeviceContext* context,gbuffer& rsm,bool clear)
	{
		...
		DXUT_Dynamic_D3DPERF_BeginEvent(0xffffff,L"LPV_Inject");
		...
		std::string debugName = "LPV_R_";
		debugName.append(std::to_string(next_));
		lpv_r_[next_].rtv()->SetPrivateData(WKPDID_D3DDebugObjectName,debugName.size(),debugName.c_str());
		debugName = "LPV_G_";
		debugName.append(std::to_string(next_));
		lpv_g_[next_].rtv()->SetPrivateData(WKPDID_D3DDebugObjectName,debugName.size(),debugName.c_str());
		debugName = "LPV_B_";
		debugName.append(std::to_string(next_));
		lpv_b_[next_].rtv()->SetPrivateData(WKPDID_D3DDebugObjectName,debugName.size(),debugName.c_str());
	...
	void light_propagation_volume::normalize(ID3D11DeviceContext* context)
	{
		...
		DXUT_Dynamic_D3DPERF_BeginEvent(0xffffff,L"LPV_Normalize");
	...
	void light_propagation_volume::propagate(ID3D11DeviceContext* context)
	{
		...
		DXUT_Dynamic_D3DPERF_BeginEvent(0xffffff,L"LPV_Propagate");
		...
		std::string debugName = "LPV_ACCUM_R";
		lpv_accum_r_.rtv()->SetPrivateData(WKPDID_D3DDebugObjectName,debugName.size(),debugName.c_str());
		debugName = "LPV_ACCUM_G";
		lpv_accum_g_.rtv()->SetPrivateData(WKPDID_D3DDebugObjectName,debugName.size(),debugName.c_str());
		debugName = "LPV_ACCUM_B";
		lpv_accum_b_.rtv()->SetPrivateData(WKPDID_D3DDebugObjectName,debugName.size(),debugName.c_str());
