...
namespace YumeEngine
{
	...
	public:
		...
		const YumeString& GetGeometryShader() const { return geometryShaderName_; }
		...
		const YumeString& GetGeometryShaderDefines() const { return geometryShaderDefines_; }
		...
		YumeVector<SharedPtr<YumeShaderVariation> >::type& GetGeometryShaders() { return geometryShaders_; }
