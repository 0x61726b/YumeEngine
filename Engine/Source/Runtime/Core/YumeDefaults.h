...
namespace YumeEngine
{
	...
	YumeAPIExport DirectX::XMFLOAT3 ToVector3(const YumeString& source);
	YumeAPIExport DirectX::XMFLOAT3 ToVector3(const char* source);
	YumeAPIExport DirectX::XMFLOAT4 ToVector4(const YumeString& source,bool allowMissingCoords = false);
	YumeAPIExport DirectX::XMFLOAT4 ToVector4(const char* source,bool allowMissingCoords = false);
