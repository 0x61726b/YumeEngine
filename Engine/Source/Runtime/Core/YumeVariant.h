...
namespace YumeEngine
{
	...
	/// Map of variants.
	typedef YumeMap<YumeStrHash,Variant>::type VariantMap;
	...
	public:
		...
		Variant(const YumeVector<unsigned char>& value):
			type_(VAR_NONE)
		{
			*this = value;
		}
		...
		Variant& operator =(const YumeVector<unsigned char>& rhs)
		{
			SetType(VAR_BUFFER);
			*(reinterpret_cast<YumeVector<unsigned char>*>(&value_)) = rhs;
			return *this;
		}
		...
		bool operator ==(const YumeVector<unsigned char>& rhs) const;
		...
		{
			return type_ == VAR_STRINGVECTOR ? *(reinterpret_cast<const YumeStringVector*>(&value_)) == rhs : false;
		}
		...
		bool operator !=(const YumeVector<unsigned char>& rhs) const { return !(*this == rhs); }
		...
		const YumeString& GetYumeString() const { return type_ == VAR_STRING ? *reinterpret_cast<const YumeString*>(&value_) : ""; }

		/// Return buffer or empty on type mismatch.
		const YumeVector<unsigned char>& GetBuffer() const
		{
			return type_ == VAR_BUFFER ? *reinterpret_cast<const YumeVector<unsigned char>*>(&value_) : emptyBuffer;
		}
		...
		{
			return type_ == VAR_STRINGVECTOR ? *reinterpret_cast<const YumeStringVector*>(&value_) : emptyYumeStringVector;
		}
		...
		YumeVector<unsigned char>* GetBufferPtr()
		{
			return type_ == VAR_BUFFER ? reinterpret_cast<YumeVector<unsigned char>*>(&value_) : 0;
		}
		...
		YumeStringVector* GetYumeStringVectorPtr() { return type_ == VAR_STRINGVECTOR ? reinterpret_cast<YumeStringVector*>(&value_) : 0; }
		...
		/// Empty buffer.
		static const YumeVector<unsigned char> emptyBuffer;
	...
	template <> inline VariantType GetVariantType<YumeVector<unsigned char> >() { return VAR_BUFFER; }
	...
	template <> inline VariantType GetVariantType<YumeStringVector>() { return VAR_STRINGVECTOR; }
	...
	template <> YumeAPIExport const YumeVector<unsigned char>& Variant::Get<const YumeVector<unsigned char>&>() const;
	...
	template <> YumeAPIExport YumeVector<unsigned char> Variant::Get<YumeVector<unsigned char> >() const;
