...
public:
	...
	virtual void render(ID3D11DeviceContext* context,ID3D11RenderTargetView* backbuffer,ID3D11DepthStencilView* dsv)
	{
		...
		DXUT_Dynamic_D3DPERF_BeginEvent(0xffffff,L"BeginRender");
		render_gi(context,clear_color);
		render_scene(context,clear_color,dsv);


		DXUT_Dynamic_D3DPERF_BeginEvent(0xffffff,L"Mips");
		...
		DXUT_Dynamic_D3DPERF_BeginEvent(0xffffff,L"Profiler & DeferredRenderer");
...
protected:
	...
	{
		DXUT_Dynamic_D3DPERF_BeginEvent(0xffffff,L"RenderGI");
#ifdef LPV
	...
	/*	if(update_rsm_)
		{*/
			DXUT_Dynamic_D3DPERF_BeginEvent(0xfffff,L"RenderRSM");
			// setup rsm view
